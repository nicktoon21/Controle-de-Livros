...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casadocodigo$1.0.0/src/app/views/livros/editar/editar.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Cadastro de livros</h1> ");
  ...
  marko_forEach(data.livros, function(livro) {
    ...
    out.w("<div><form><div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" placeholder=\"coloque o titulo\" value=\"" +
      ...
      "</textarea></div><button formaction=\"/livros\" formmethod=\"put\" name=\"id\" value=\"" +
      marko_escapeXmlAttr(livro.id) +
      "\">Alterar</button></form> </div>");
  });
...
marko_template.meta = {
    id: "/casadocodigo$1.0.0/src/app/views/livros/editar/editar.marko",
    tags: [
